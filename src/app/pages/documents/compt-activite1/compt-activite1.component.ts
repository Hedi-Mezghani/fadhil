...
import { DossierActiviteService } from 'src/app/service/dossier-activite.service';
import { ComptActiviteUploadComponent } from '../compt-activite-upload/compt-activite-upload.component';

@Component({
  selector: 'app-compt-activite1',
  templateUrl: './compt-activite1.component.html',
  styleUrls: ['./compt-activite1.component.css']
})
export class ComptActivite1Component implements OnInit {
...
selectedUserId:any;
  ...
  (
    ...
    public dialogref: MatDialogRef<ComptActivite1Component>,
    private dossierService: DossierActiviteService,
...
getDossiers() {
  ...
  onCreate(item:User) {
    ...
    this.dialog
      ...
      .open(ComptActiviteUploadComponent, {
        data: { utilisateurId: this.data.utilisateurId },
      })
      .afterClosed()
      .subscribe((res) => {
       // this.loadProject();
