...
import { ComptActivite1Component } from '../compt-activite1/compt-activite1.component';


@Component({
  selector: 'app-compt-activity',
  templateUrl: './compt-activity.component.html',
  styleUrls: ['./compt-activity.component.css']
})
export class ComptActivityComponent implements OnInit {
...
onCreate(item:User) {
  ...
  this.dialog
    .open(ComptActivite1Component, dialogconfig)
    .afterClosed()
    .subscribe((res) => {
     // this.loadProject();
    });
